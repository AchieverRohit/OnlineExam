...
namespace thinkschool.OnlineExam.Core.Models
{
    ...
    public class ExamDetailsResponseDto : IMapFrom<Exam>
    {
        public int ExamId { get; set; }
        public string Title { get; set; }
        public string Description { get; set; }
        ...
        public virtual List<SectionDetailsResponseDto>? SectionExams { get; set; }
    }
    public class SectionDetailsResponseDto : IMapFrom<Section>
    {
